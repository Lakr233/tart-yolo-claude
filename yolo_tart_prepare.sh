...
install_dev_tools() {
    ...
    execute_vm_command "brew install --force git curl wget htop npm corepack vim nano jq yq coreutils sshpass swiftformat xcbeautify python"
    execute_vm_command "brew install --cask --force codex"
    execute_vm_command "brew install --force opencode"
