...
export BOOT_COMMAND='cd ~/projects && (command -v opencode >/dev/null 2>&1 && opencode || command -v opencode-ai >/dev/null 2>&1 && opencode-ai || (echo "[-] opencode not found" >&2; exit 1))'
